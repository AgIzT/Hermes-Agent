...
def _hermes_user_agent_headers() -> Dict[str, str]:
...
def _to_async_client(sync_client, model: str, is_vision: bool = False):
    ...
    inherited_headers = getattr(sync_client, "_custom_headers", None)
    if isinstance(inherited_headers, dict) and inherited_headers:
        async_kwargs["default_headers"] = dict(inherited_headers)
